...
function GetTarget()
    ...
    for r, v in pairs(game.Players:GetPlayers()) do
        if v and v.Name ~= plr.Name and v.Parent and v.Character and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 and
    ...
    if checktarget() then
        if target and target.Character and target.Character:FindFirstChild("Humanoid") and target.Character.Humanoid.Health > 4 then
            ...
            if enemy.Character:FindFirstChild("Humanoid") and enemy.Character.Humanoid.MoveDirection.Magnitude > 0 then
                ...
                Tweento(enemy.Character.HumanoidRootPart.CFrame * CFrame.new(0, 0, 4))
            end
        end
    end
end
