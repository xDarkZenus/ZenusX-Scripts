...
local setidentity = syn and syn.set_thread_identity or set_thread_identity or setidentity or setthreadidentity or function()
end
...
local aa = {
	function()
		...
		local w = u('ScreenGui', {
			Parent = i:IsStudio() and j.PlayerGui or j.PlayerGui
		})
		v(w)
		t:Init(w)
		local x = {
